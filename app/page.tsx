...
export default function HomePage() {
  ...
  const [showProjectRequestOptions, setShowProjectRequestOptions] = useState(false)
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (showProjectRequestOptions) {
        const target = event.target as Element
        if (!target.closest('.project-request-dropdown')) {
          setShowProjectRequestOptions(false)
        }
      }
    }
  ...
  const handleCallClick = () => {
    window.location.href = "tel:+233557690525"
  }

  const handleEmailClick = () => {
    const subject = encodeURIComponent("Free Estimate Request - KBC Construction")
    const body = encodeURIComponent(`Hello KBC Construction,
...
Thank you,`)
  ...
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hello KBC Construction! I'm interested in getting a free estimate for a construction project. Could you please provide me with more information?")
    window.open(`https://wa.me/233557690525?text=${message}`, '_blank')
  }

  const handleRequestSimilarProject = () => {
    setShowProjectRequestOptions(!showProjectRequestOptions)
  }

  const handleProjectRequestEmail = () => {
    const subject = encodeURIComponent("Similar Project Request - KBC Construction")
    const body = encodeURIComponent(`Hello KBC Construction,

I am interested in requesting a similar project to the ones showcased on your website. I would like to discuss:

- Project specifications and customization options
- Timeline and project phases
- Pricing and payment plans
- Available locations for construction
...
Thank you,`)
  ...
  const handleProjectRequestWhatsApp = () => {
    const message = encodeURIComponent("Hello KBC Construction! I saw your featured projects and I'm interested in requesting a similar project. Could we discuss the specifications, timeline, and pricing? I'd love to schedule a consultation.")
    window.open(`https://wa.me/233557690525?text=${message}`, '_blank')
    setShowProjectRequestOptions(false)
  }

  const handleProjectRequestCall = () => {
    window.location.href = "tel:+233557690525"
    setShowProjectRequestOptions(false)
  }
      ...
      <header className="bg-white/95 backdrop-blur-sm shadow-sm sticky top-0 z-50 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Button 
              className="bg-orange-600 hover:bg-orange-700 transform transition-all duration-300 hover:scale-105 hover:shadow-lg"
              onClick={(e) => smoothScroll(e as any, "contact")}
            >
              Get Quote
            </Button>
          </div>
            ...
            <div className="relative inline-block">
              ...
              >
                ...
                <div className="ml-2 flex items-center space-x-1">
                  ...
                  <ChevronDown className={`w-4 h-4 transition-transform duration-300 ${showProjectRequestOptions ? 'rotate-180' : ''}`} />
                </div>
              </Button>
              ...
              {showProjectRequestOptions && (
                <>
                  {/* Backdrop */}
                  <div className="fixed inset-0 bg-black/10 backdrop-blur-sm" style={{ zIndex: 9999998 }} onClick={() => setShowProjectRequestOptions(false)} />
                  
                  <div 
                    className="project-request-dropdown absolute top-0 left-full ml-2 bg-white rounded-lg shadow-2xl border border-gray-200 p-4 min-w-[320px] animate-in fade-in slide-in-from-left-2 duration-200 drop-shadow-2xl" 
                    style={{ zIndex: 9999999 }}
                  >
                  <div className="text-center mb-4">
                    <h4 className="font-semibold text-gray-800 mb-1">Request Similar Project</h4>
                    <p className="text-sm text-gray-600">Get in touch to discuss your custom project needs</p>
                  </div>
                  <div className="space-y-2">
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full justify-start hover:bg-orange-50 hover:border-orange-300 hover:text-orange-700 transition-all duration-200 group"
                      onClick={handleProjectRequestCall}
                    >
                      <Phone className="mr-3 w-4 h-4 text-orange-600 group-hover:text-orange-700" />
                      <div className="text-left">
                        <div className="font-medium">Call Now</div>
                        <div className="text-xs text-gray-500 group-hover:text-orange-600">+233 55 769 0525</div>
                      </div>
                    </Button>
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full justify-start hover:bg-orange-50 hover:border-orange-300 hover:text-orange-700 transition-all duration-200 group"
                      onClick={handleProjectRequestEmail}
                    >
                      <Mail className="mr-3 w-4 h-4 text-orange-600 group-hover:text-orange-700" />
                      <div className="text-left">
                        <div className="font-medium">Send Email</div>
                        <div className="text-xs text-gray-500 group-hover:text-orange-600">Pre-filled project request</div>
                      </div>
                    </Button>
                    <Button
                      variant="outline"
                      size="sm"
                      className="w-full justify-start hover:bg-green-50 hover:border-green-300 hover:text-green-700 transition-all duration-200 group"
                      onClick={handleProjectRequestWhatsApp}
                    >
                      <svg className="mr-3 w-4 h-4 text-green-600 group-hover:text-green-700" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-xs text-gray-500 group-hover:text-green-600">Instant messaging</div>
                      </div>
                    </Button>
                  </div>
                  <div className="mt-3 pt-3 border-t border-gray-100 text-center">
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => setShowProjectRequestOptions(false)}
          ...
          <FadeInSection delay={600} className="text-center">
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button
                ...
                className="bg-green-600 text-white hover:bg-green-700 transform transition-all duration-300 hover:scale-105 hover:shadow-xl group"
              >
            ...
            <p className="text-orange-100 text-sm mt-4">Choose your preferred way to get in touch!</p>
          </FadeInSection>
        </div>
      </section>
